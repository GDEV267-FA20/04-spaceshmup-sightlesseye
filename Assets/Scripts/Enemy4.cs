            ...
            case "ProjectileHero": 
                ...
                {    
                    foreach (string s in prtHit.protectedBy) { 
                        ...
                        if (!Destroyed(s)) {    // ...then don't damage this part yet 
                ...
                if (allDestroyed) {             
                    // If it IS completely destroyed, tell the Main singleton that this ship was destroyed
